Feature: Sample Snippets test
    ...
    #@Isolate
    Scenario: open URL
        Given the page url is not "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.html"
        And   I open the url "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.html"
        Then  I expect that the url is "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.html"
        And   I expect that the url is not "http://google.com"

    Scenario: open sub page of weburl
        Given the page url is not "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.htmltwo.html"
        And   I open the url "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.html"
        Then  I expect that the url is "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.html"
        And   I expect that the url is not "http://google.com"
    ...
    Scenario: click on button
        Given I open the url "https://guinea-pig.s3-eu-west-1.amazonaws.com/index.html"
